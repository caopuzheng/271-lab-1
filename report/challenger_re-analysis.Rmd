...
```{r model-1-stargazer, echo=FALSE}
stargazer(mod1,
...
```{r model23-stargazer, echo=FALSE}
stargazer(mod2, mod3,
  type = "text", omit.stat = "f",
  report = ("vc*p"),
  star.cutoffs = c(0.05, 0.01, 0.001),
...
```{r Graph-Expected-number-of-failures-vs-Temp, echo=FALSE}
curve(
...
```{r resample-with-replacement, message=FALSE}
