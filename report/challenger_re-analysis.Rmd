...
```{r Distribution Plots, echo=FALSE, message=FALSE}
p1 <- challenger %>%
  ggplot(aes(x = Temp)) +
  geom_density(aes(
    y = ..density..,
...
```{r checking linear model Homeoskedasticity, echo=FALSE, message=FALSE}
...
For those reasons, if we wanted to model this properly, a logistic regression would have to be use.
