...
l1<-round(1/exp(c.value*beta.hat2 ), 4)

# Odds for j = 3 vs j = 1 (Shelf 3 vs Shelf 1)
l2<-round(1/exp(c.value*beta.hat3 ), 4)

# Odds for j = 4 vs j = 1 (Shelf 4 vs Shelf 1)
l3<-round(1/exp(c.value*beta.hat4 ), 4)


odds_ratios <- rbind(l1, l2, l3)
odds_ratios
```

> 'Fill this in: What do you learn about each of these variables?
The odds of a cereal being place on Shelf 2 vs being place on Shelf 1 change by 0.4843 times for a 0.2692 decreases in sugar content holding all other variable constant. 
The odds of a cereal being place on Shelf 3 vs being place on Shelf 1 change by 26.8071 times for a 0.2692 decreases in sugar content holding all other variable constant. 
The odds of a cereal being place on Shelf 4 vs being place on Shelf 1 change by 21.4814 times for a 0.2692 decreases in sugar content holding all other variable constant. 
The odds of a cereal being place on Shelf 2 vs being place on Shelf 1 change by 0.2966 times for a 0.299 decreases in fat content holding all other variable constant. 
The odds of a cereal being place on Shelf 3 vs being place on Shelf 1 change by 1.1813 times for a 0.299 decreases in fat content holding all other variable constant. 
The odds of a cereal being place on Shelf 4 vs being place on Shelf 1 change by 1.2971 times for a 0.299 decreases in fat content holding all other variable constant. 
The odds of a cereal being place on Shelf 2 vs being place on Shelf 1 change by 55.7044 times for a 0.2298 decreases in sodium content holding all other variable constant.
The odds of a cereal being place on Shelf 3 vs being place on Shelf 1 change by 311.0825 times for a 0.2298 decreases in sodium content holding all other variable constant.
The odds of a cereal being place on Shelf 4 vs being place on Shelf 1 change by 290.0490 times for a 0.2298 decreases in sodium content holding all other variable constant.' 
